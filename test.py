...
import time
import cv2
os.environ["CUDA_VISIBLE_DEVICES"] = '6,5,7'
import torch
...
def test(opt):
    ...
    result_dict, length_of_data = evaluation(model, evaluation_loader, converter, opt, tqdm_position=0)
    print(result_dict)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--eval_data",
        default="/home/gaurav/scratch/ABINet/data/test",
